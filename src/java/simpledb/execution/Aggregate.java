...
public class Aggregate extends Operator {
     ...
     * @param gfield The column over which we are grouping the result, or -1 which is {@link Aggregator#NO_GROUPING} if
    ...
    private void resetIterator() throws TransactionAbortedException, DbException {
